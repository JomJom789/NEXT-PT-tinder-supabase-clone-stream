...
// Configuration
const SUPABASE_URL = `https://jtgltcykgqdsqigiitye.supabase.co`;
const SUPABASE_SERVICE_ROLE_KEY = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp0Z2x0Y3lrZ3Fkc3FpZ2lpdHllIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2MTE5NTk2NSwiZXhwIjoyMDc2NzcxOTY1fQ.SRQxw4x7UrAeMbcyxhHljVEJ4VLL8w_vc9dC8fnuLfQ`;
